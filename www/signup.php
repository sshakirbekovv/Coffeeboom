...
<div class="login-page">
  <div class="form">
    ...
    <form class="login-form" action="reg.php" method="post">
      <input class="txt" type="text" placeholder="имя" name="name" required/>
      <input class="txt" type="text" placeholder="фамилия" name="surname" required/>
      <input class="txt" type="password" placeholder="пароль" name="password" required/>
      <input class="txt" type="text" placeholder="адрес" name="address" required/>
      <input type="submit" class="button" value="зарегистрироваться"></input>
    </form>
  </div>
</div>
</center>
